...
**Q: آیا می‌توانم چند پورت را با یک تانل فوروارد کنم؟** (جدید در v1.0.2)
A: بله! هنگام اضافه کردن Port Forward، گزینه "Multiple ports forward" را انتخاب کنید و پورت‌ها را با کاما جدا کنید (مثلاً 9090,9091,9092). این روش کارآمدتر است چون از یک تانل SOCKS5 مشترک استفاده می‌کند.
