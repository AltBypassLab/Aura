...
یکی از مهم‌ترین امکانات جدید Phoenix v1.0.1 قابلیت **Fingerprint Spoofing** است که به شما اجازه می‌دهد اتصالات خود را شبیه مرورگرهای واقعی کنید.
...
- **زبان**: Bash
- **نسخه فعلی**: 1.0.1
- **امکانات جدید v1.0.1**: Fingerprint Spoofing, ECDSA Support, 5 TLS Modes
